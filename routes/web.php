...
Route::middleware('role:parent')->prefix('parent')->group(function () {
    ...
    Route::get('/absences/etudiant/{etudiant}', [ParentPresenceController::class, 'showEtudiantAbsences'])
        ->name('parent.presences.etudiant')
        ->middleware('can:view,etudiant');

    // Route pour récupérer les étudiants assignés à un parent (utilisée par le menu déroulant)
    Route::get('/api/etudiants-assignes', [ParentPresenceController::class, 'getAssignedStudents'])
        ->name('parent.api.assigned-students');
});
